				...
				<div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
					...
					<div class="app-header-wrapper d-flex flex-grow-1 align-items-stretch justify-content-between" id="kt_app_header_wrapper">
						...
						<div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3">
                                <!--begin::Menu wrapper-->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_recordatorio">
                                    Agregar Recordatorio y Factura
                                </button>
                                <!--end::Menu wrapper-->
                            </div>
							<!--begin::Chat-->
						...
						<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-0">
							...
							<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <span class="h1" id="fechday">Title</span>

                                    <script>
                                        // Obtener el elemento span por su id
                                        var fechaElement = document.getElementById('fechday');
                                        ...
                                        function actualizarFecha() {
                                            ...
                                            var fechaFormateada = diaSemana + ' ' + dia + ' de ' + nombreMes;

                                            // Establecer el contenido del elemento span con la fecha formateada
                                            fechaElement.textContent = fechaFormateada;
                                        }

                                        // Llamar a la función actualizarFecha cada 3 segundos
                                        setInterval(actualizarFecha, 3000);
                                    </script>
									<!--end::Filter menu-->
...
<button onclick="confirmarEliminarVenta(${venta.id})" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
            ...
            `;
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-header pt-7">
                                                <!--begin::Title-->
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-gray-900">Recordatorios de pagos</span>
                                                </h3>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Header-->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                                    <!--begin::Item-->
                                                    <div class="contenedor-recordatorios"></div>
                                                    <script>

                                                        let recordatoriosMostrados = [];

                                                        document.addEventListener('DOMContentLoaded', function() {
                                                            cargarRecordatorios();
                                                            setInterval(cargarRecordatorios, 3000);
                                                        });

                                                        function cargarRecordatorios() {
                                                            fetch('php/recordatoriosArray.php')
                                                                .then(response => response.json())
                                                                .then(data => {
                                                        ...
                                                        function mostrarRecordatorios(recordatorios) {
                                                            const contenedor = document.querySelector('.contenedor-recordatorios');

                                                            // Crear un conjunto con los IDs de los recordatorios actuales
                                                            const recordatoriosActuales = new Set(recordatorios.map(recordatorio => recordatorio.id));

                                                            // Recorrer los recordatorios mostrados y eliminar los que ya no están presentes
                                                            recordatoriosMostrados = recordatoriosMostrados.filter(recordatorioId => {
                                                                if (!recordatoriosActuales.has(recordatorioId)) {
                                                                    const elemento = contenedor.querySelector(`[data-recordatorio-id="${recordatorioId}"]`);
                                                                    if (elemento) {
                                                                        elemento.classList.remove('animate__fadeInRight');
                                                                        elemento.classList.add('animate__bounceOutLeft');
                                                                        elemento.addEventListener('animationend', () => {
                                                            ...
                                                            recordatorios.forEach(recordatorio => {
                                                                if (!recordatoriosMostrados.includes(recordatorio.id)) {
                                                                    const elemento = document.createElement('div');
                                                                    elemento.classList.add('d-flex', 'align-items-center', 'mb-6', 'animate__animated', 'animate__fadeInRight');
                                                                    elemento.setAttribute('data-recordatorio-id', recordatorio.id);

                                                                    // Calcular los días restantes para pagar
                ...
                <div class="flex-grow-1 me-5">
                    <div class="text-gray-800 fw-semibold fs-6">Factura #${recordatorio.id_factura}</div>
                    <div class="text-gray-700 fw-semibold fs-6">Proveedor: ${recordatorio.proveedor}</div>
                    <div class="text-gray-500 fw-semibold fs-7">Fecha de emisión: ${recordatorio.fecha_emision}</div>
                    <div class="text-gray-500 fw-semibold fs-7">Fecha de vencimiento: ${recordatorio.fecha_vencimiento}</div>
                    <div class="text-gray-800 fw-semibold fs-6">Monto: ${recordatorio.monto}</div>
                    <div class="text-gray-700 fw-semibold fs-6">Fecha de recordatorio: ${recordatorio.fecha_recordatorio}</div>
                    <div class="text-gray-500 fw-semibold fs-7">Descripción: ${recordatorio.descripcion}</div>
                    <button onclick="confirmarEliminarRecordatorio(${recordatorio.id})" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
                        <i class="fas fa-trash-alt"></i>
                    </button>
<button onclick="pagarRecordatorio(${recordatorio.id}, ${recordatorio.monto})" class="btn btn-icon btn-bg-light btn-active-color-success btn-sm">
                        <i class="fas fa-money-bill-alt"></i>
                    </button>
                </div>
                <div class="text-end">
                    <span class="badge badge-light-warning fs-7 fw-bold">${diasRestantes} días restantes</span>
                </div>
            `;
                                                                    contenedor.prepend(elemento);
                                                                    recordatoriosMostrados.push(recordatorio.id);
                                                                    // Calcular la sumatoria de las facturas
                                                                    const sumatoria = recordatorios.reduce((total, recordatorio) => total + parseFloat(recordatorio.monto), 0);

                                                                    // Mostrar la sumatoria en el HTML
                                                                    const sumatoriaElemento = document.querySelector('.sumatoria-facturas');
                                                                    sumatoriaElemento.textContent = `Sumatoria de Facturas: ${sumatoria.toFixed(2)}`;
                                                                }
                                                            });
                                                        }
                                                        ...
                                                        function confirmarEliminarRecordatorio(recordatorioId) {
                                                            Swal.fire({
                                                                html: `¿Estás seguro de eliminar este recordatorio?`,
                                                                icon: "question",
                                                                buttonsStyling: false,
                                                                showCancelButton: true,
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    // Enviar solicitud AJAX a PHP para eliminar el recordatorio
                                                                    fetch(`php/eliminarRecordatorio.php?id=${recordatorioId}`)
                                                                        .then(response => response.json())
                                                                        .then(data => {
                                                                            if (data.success) {
                                                                                Swal.fire({
                                                                                    ...
                                                                                    // Actualizar la lista de recordatorios después de cerrar el SweetAlert
                                                                                    cargarRecordatorios();
                                                                                });
                                                                            } else {
                                                                                Swal.fire({
                                                                        ...
                                                                        .catch(error => {
                                                                            ...
                                                                            Swal.fire({
                                                                                title: 'Error',
                                                                                text: 'Hubo un error al eliminar el recordatorio. Por favor, intenta nuevamente.',
                                                                                icon: 'error',
                                                                                buttonsStyling: false,
                                                                                customClass: {
                                                                                    confirmButton: "btn btn-primary"
                                                        ...
                                                        function pagarRecordatorio(recordatorioId, monto) {
                                                            Swal.fire({
                                                                html: `¿Estás seguro de pagar este recordatorio?`,
                                                                icon: "question",
                                                                buttonsStyling: false,
                                                                showCancelButton: true,
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    // Enviar solicitud AJAX a PHP para registrar el pago en la tabla de gastos
                                                                    fetch(`php/pagarR.php?id=${recordatorioId}&monto=${monto}`)
                                                                        .then(response => response.json())
                                                                        .then(data => {
                                                                            if (data.success) {
                                                                                Swal.fire({
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="fs-4 fw-semibold text-gray-700">
                                                    <div class="sumatoria-facturas">suma</div>
                                                </div>
                                            </div>
                                            <!--end::Body-->
                                        </div>
...
Si necesitas manejar las respuestas, no las pongas con **texto** sino con estilo bold. Puedes encerrarlo con una etiqueta <strong> o puedes encerrar el texto en <div class="text-gray-900">texto aquí</div> y en otros estilos para destacar la respuesta y que sea más bonita, como <div class="text-white"></div>.
...
Por favor, sigue este formato para todas las respuestas.`;
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_recordatorio">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Agregar Recordatorio y Factura</h3>
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                        <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" id="guardarRecordatorio">Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.getElementById('guardarRecordatorio').addEventListener('click', function() {
            ...
            fetch('php/insertar_recordatorio.php', {
                method: 'POST',
                body: formData
            })
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
                        ...
                        const modal = document.getElementById('kt_modal_recordatorio');
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Éxito',
                            text: 'Recordatorio y factura guardados exitosamente',
                            buttonsStyling: false,
                            customClass: {
                                confirmButton: 'btn btn-primary'
                            }
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            html: `Error al guardar el recordatorio y la factura: <strong>${data.error}</strong>`,
                            buttonsStyling: false,
                            customClass: {
                                confirmButton: 'btn btn-danger'
                            }
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Error al guardar el recordatorio y la factura',
                        buttonsStyling: false,
                        customClass: {
                            confirmButton: 'btn btn-danger'
                        }
